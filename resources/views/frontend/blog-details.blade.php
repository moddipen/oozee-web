    ...
    <section class="breadcrumbs-custom">
        <div class="container">
            <div class="breadcrumbs-custom__inner">
                <p class="breadcrumbs-custom__title">{{ $blog->title }}</p>
                ...
                <div class="col-lg-8 section-divided__main">
                    <section class="section-md">
                        ...
                        <figure class="figure"><img
                                    src="{{ $blog->getFirstMediaUrl('blog') ? asset($blog->getFirstMediaUrl('blog')) : 'public/frontend/images/typography-2-418x315.jpg' }}"
