                        ...
                        @if(Auth::user()->hasAnyPermission(['permission-create']))
                            <div class="pull-right">
                                <a href="{{ route('admin.permissions.create') }}" type="button"
                                   ...
                                   data-toggle="tooltip" data-placement="left" data-original-title="Add New permission"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="deleteLabel">Delete Permission</h4>
    ...
    <script>
        $(function () {
            ...
            $('#users-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{!! route('admin.ajax.permissions') !!}',
                columns: [
